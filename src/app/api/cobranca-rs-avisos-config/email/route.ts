...
import { parseBody, cobrancaRsAvisoEmailCreateSchema } from "@/lib/schemas";
...
export async function POST(request: NextRequest) {
  ...
  const parsed = parseBody(cobrancaRsAvisoEmailCreateSchema, body);
  ...
  registrarAuditoria({
    ...
    acao: "cobranca_rs_aviso_email_adicionado",
